					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								<br><div class="tampil-foto"><img src="{{ asset('images/'.Auth::user()->foto) }}" width="200">
							</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input id="password1" type="password" class="form-control" data-match="#password" name="password">
								<span class="help-block with-errors"></span>
							</div>
						</div>
