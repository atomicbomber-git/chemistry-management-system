...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if(Auth::user()->level == 1) return view('home.admin', compact('kategori', 'produk', 'member', 'awal', 'akhir', 'data_pendapatan', 'data_tanggal'));
        else return view('home.ketualab', compact('kategori', 'produk', 'member', 'awal', 'akhir', 'data_pendapatan', 'data_tanggal'));
    }
}
